...
import { genTimeline, computeAll, TODAY_N } from "@/components/tracker/pkEngine";
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: "16px 12px 32px" }}>
        ...
        {tab === "wellbeing"&& <WellbeingTab tl={tl} tlM={tlM} tN={tN} peakWB={peakWB} />}
        {tab === "pd"       && <PDTab tl={tl} tN={tN} tW={tW} />}
        {tab === "sert"     && <SERTTab tl={tl} tN={tN} />}
        {tab === "rec"      && <ReceptorTab tl={tl} tN={tN} />}
        {tab === "plasma"   && <PlasmaTab tl={tl} tN={tN} />}
